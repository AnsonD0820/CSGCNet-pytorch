...
img_path = "/home/wuyi/AnsonD/CSGCNet/Output_RGB_potsdam_CSGCNet"
...
def test(config):
    ...
    state_name = "potsdam_CSGCNet_600x600" + f"_iter_{it}.pth"

    #ignore_idx = params["dataset_config"]["ignore_idx"]
    base_path_pretrained = Path("/home/wuyi/AnsonD/CSGCNet/potsdam_CSGCNet")
    ...
    for index, batch in enumerate(dl_test):
        ...
        for i in range(pred_label_imgs.shape[0]):
            ...
            mask = get_color_pallete_isprs(pred_label_imgs[i], dataset="potsdam")
            mask.save("/home/wuyi/AnsonD/CSGCNet/Output_RGB_potsdam_CSGCNet" + "/" + t + ".png")
            j = j + 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config',
                    type=str,
                    default="/home/wuyi/AnsonD/CSGCNet/configs/train_potsdam.json",)
