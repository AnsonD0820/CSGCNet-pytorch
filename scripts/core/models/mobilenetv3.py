...
def mobilenetv3_small(pretrained=False, width_mult=1., weights=None):
	...
	return MobileNetV3(cfgs, mode='small', pretrained=pretrained, width_mult=width_mult, weights=weights)

if __name__=='__main__':
	path = Path("/home/wuyi/AnsonD/CABiNet-master/scripts/core/models/pretrained_backbones")
